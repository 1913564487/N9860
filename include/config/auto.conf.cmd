...
ifneq "$(CC)" "/home/hsy/clang3/llvm/bin/clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/home/hsy/clang3/aarch64/bin/aarch64-linux-android-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "/home/hsy/clang3/aarch64/bin/aarch64-linux-android-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/home/hsy/clang3/aarch64/bin/aarch64-linux-android-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/home/hsy/clang3/aarch64/bin/ --gcc-toolchain=/home/hsy/clang3/aarch64 -no-integrated-as  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
